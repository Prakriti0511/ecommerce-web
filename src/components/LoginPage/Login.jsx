...
function Login() {
      ...
      <div className = 'w-[100%] h-[100vw] bg-gradient-to-l from-[#898AC4] to-[#C0C9EE] text-[white] flex flex-col gap-[10px] font-gill'>
          <div className = 'w-[100%] h-[100px] flex flex-col items-center justify-center'>
              <span className='text-[25px] font-semibold pb-[10px] font-gill'>Login Page</span>
              <span className = 'text-[16px] font-semibold'>Welcome back!</span>
          </div>
          <div className = 'max-w-[600px] w-[90%] h-[500px] bg-[#FFF2E0] rounded-[10px] border border-white backdrop-blur-2xl shadow-lg flex items-center justify-center mx-auto'>
              <form action="" className='w-[90%] h-[90%] flex flex-col items-center justify-start gap-[20px]'>
                  ...
                  <div className = 'w-[90%] h-[400px] flex flex-col items-center justify-center gap-[15px] relative'>
                      ...
                      <button className='w-[100%] h-[50px] bg-[white] rounded-[10px] flex items-center justify-center mt-[20px] text-[17px] text-[#2d3748] font-semibold'>Login </button>
                      <p className='flex gap-[10px]'>You have no account? <span className='text-[#] text-[17px] font-semibold cursor-pointer' onClick={()=>navigate("/signup")}>Sign Up</span></p>                    
                  </div>
              </form>
          </div>
      </div>
