    ...
    <div className = 'w-[100%] h-[100vw] bg-gradient-to-l from-[#898AC4] to-[#C0C9EE] text-[white] flex flex-col gap-[10px] font-gill'>
        ...
        <div className = 'max-w-[600px] w-[90%] h-[500px] bg-[#FFF2E0] rounded-[10px] border border-white backdrop-blur-2xl shadow-lg flex items-center justify-center mx-auto'>
            <form action="" className='w-[90%] h-[90%] flex flex-col items-center justify-start gap-[20px]'>
                <div className = 'w-[90%] h-[50px] bg-[#898AC4] text-[black] border-2 border-[#C0C9EE] rounded-[10px] shadow-lg flex items-center justify-center gap-[10px] py-[20px] cursor-pointer'>
                ...
                <div className = 'w-[90%] h-[400px] flex flex-col items-center justify-center gap-[15px]'>
                    ...
                    <input type = "password" className = 'w-[80%] h-[50px] border-[2px] border-[#C0C9EE] backdrop:blur-sm rounded-[10px] shadow-lg bg-transparent placeholder-[#] px-[20px] font-semibold' placeholder = 'Password' required/>
                    <button className='w-[100%] h-[50px] bg-[#898AC4] rounded-[10px] flex items-center justify-center mt-[20px] text-[17px] font-semibold'> Create Account </button>
                    <p className='flex gap-[10px]'>You have any account? <span className='text-[#] text-[17px] font-semibold cursor-pointer'>Login</span></p>
